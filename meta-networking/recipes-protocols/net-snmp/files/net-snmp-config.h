 ...
 * 
 * Wind River: change net-snmp-config-ppc.h to net-snmp-config-powerpc.h
 *             change net-snmp-config-ppc64.h to net-snmp-config-powerpc64.h
*/
...
#include "net-snmp-config-powerpc64.h"
#elif defined(__powerpc__)
#include "net-snmp-config-powerpc.h"
